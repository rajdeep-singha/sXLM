...
export class StakingEngine {
     ...
     */
    async recalculateWithdrawalQueueAfterSlash(slashAmount) {
        ...
        console.log(`[StakingEngine] Slashing recalculation: ${recalculated} pending withdrawals adjusted by factor ${reductionFactor.toFixed(6)} (slash: ${Number(slashAmount) / 1e7} XLM)`);
    }
    // --- Admin operations ---
    async applySlashing(slashAmountStroops) {
