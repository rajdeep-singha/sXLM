...
export class KeeperBot {
    ...
    async runHarvestCycle() {
        ...
        try {
            ...
            console.log(`[KeeperBot] add_rewards called with ${Number(harvested) / 1e7} XLM — sXLM rate will increase`);
        }
        catch (err) {
            ...
            console.error(`[KeeperBot] MANUAL ACTION REQUIRED: call add_rewards with ${harvested} stroops`);
        }
    }
    // ============================================================
