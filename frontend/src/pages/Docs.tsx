    ...
    <div className="prose-custom max-w-none">
      ...
      <section id="welcome" className="scroll-mt-20">
        <div className="mb-6">
          ...
          <p className="text-black/60 text-lg">An XLM vault built on Stellar Soroban.</p>
        </div>

        <P>
          StelloFi is an XLM vault that accepts XLM deposits and issues <strong className="text-black font-medium">sXLM</strong> — a vault share token
          representing a proportional claim on the XLM the vault holds.
        </P>
        <P>
          sXLM is a composable share token backed by pooled XLM and redeemable at the vault rate. That rate rises only when XLM
          is contributed to the vault. <strong className="text-black font-medium">No strategy allocation is implemented, so it does not rise on its own
          today</strong> — see Current Limits.
        </P>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-8">
          ...
          <InfoCard tag="Redemption" title="Vault Rate" desc="sXLM redeems for its share of pooled XLM, computed from the balance on every read." />
        </div>
      ...
      <section id="sxlm-token" className="scroll-mt-20">
        ...
        <P>
          ...
          or share wrapper — a tokenized claim on a proportional share of all XLM held by the vault.
        </P>
        <P>
      ...
      <section id="exchange-rate" className="scroll-mt-20">
        ...
        <P>
          When XLM is contributed to the vault — from strategy revenue, once strategies exist, or from a direct contribution —
      ...
      <section id="current-limits" className="scroll-mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-4">
          {[
            ...
            { title: 'No external strategies', desc: 'Nothing is routed to Blend or other protocols. Vault yield comes only from interest paid by borrowers in this protocol\u2019s own lending market, so it scales with borrowing, not with deposits.' },
